...
const ResumeAnalyzer = lazy(() => import('./dashboard/ResumeAnalyzer').then(module => ({ default: module.ResumeAnalyzer })));
const LinkedInAnalyzer = lazy(() => import('./dashboard/LinkedInAnalyzer').then(module => ({ default: module.LinkedInAnalyzer })));
const ResumeTailor = lazy(() => import('./dashboard/ResumeTailor').then(module => ({ default: module.ResumeTailor })));
const JobAnalytics = lazy(() => import('./dashboard/JobAnalytics').then(module => ({ default: module.JobAnalytics })));
const SettingsPage = lazy(() => import('./dashboard/Settings').then(module => ({ default: module.Settings })));
...
export function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-dark-950">
      {/* Mobile Header */}
      <div className="lg:hidden fixed top-0 left-0 right-0 z-50 bg-dark-900 border-b border-dark-800">
        <div className="flex items-center justify-between px-4 py-4">
          <div className="flex items-center space-x-2">
            <Sparkles className="h-6 w-6 text-primary-500" />
            <h2 className="text-xl font-semibold text-white">SkillBridge AI</h2>
          </div>
          <button
      ...
      {/* Sidebar - Mobile */}
      <div
        className={`fixed top-0 left-0 h-full w-64 bg-dark-900 z-50 transform transition-transform duration-300 ease-in-out lg:hidden ${
      ...
      <div className="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-64 lg:flex-col">
        <div className="flex flex-col flex-grow bg-dark-900 border-r border-dark-800">
